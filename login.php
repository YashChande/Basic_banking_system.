...
<head>
    ...
    define('bankName', 'TSF Project : HBFC Bank', );
...
<h1 class="alert alert-success rounded-0"><?php echo bankName; ?><small class="float-right text-muted" style="font-size: 16pt;"><kbd>Presented by: Yash Chande</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
